...
\begin{itemize}
    ...
    dei cicli di sviluppo caratterizzanti Scrum (metodologia più utilizzata in passato). Inoltre, il team ha accolto
    positivamente questo nuovo approccio, in quanto ha permesso di lavorare in maniera più autonoma, e con un maggior
    senso di responsabilità grazie all'orizzontalità del team.
\end{itemize}
