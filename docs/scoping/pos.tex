...
\begin{enumerate}
    ...
    \item Rischio: in alcune zone con basso segnale, l'aggiornamento in tempo reale sulla ricarica di una propria auto
    potrebbe subire dei ritardi.
\end{enumerate}
...
requisito 5.1 del RBS), per cui un approccio lineare non è adatto.\\
...
presi in considerazione o non siano stati completamente definiti.
