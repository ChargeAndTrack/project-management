...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        un'auto registrata;
        \item aggiunta di una funzionalità per avviare una ricarica associando un'auto registrata ad una colonnina di ricarica;
    \end{enumerate}
...
\begin{itemize}
    ...
    \item 2.3, 3.2, 4.1 - \textbf{rischio}: introduzione di bug nel software delle colonnine di ricarica;
    \item 5.1 - \textbf{rischio}: incertezza nella realizzazione di un algoritmo per generare il percorso ottimizzato.
\end{itemize}
