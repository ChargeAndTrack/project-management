...
team di sviluppo. \\ \\
Al termine di ogni sessione il verbale stilato viene condiviso con tutti i partecipanti per la revisione e
...
\begin{itemize}
    ...
    \item introduzione dei project manager del fornitore e del cliente;
...
\begin{itemize}
    \item Introduzione e scopo della sessione;
