...
dello scope al project manager, il quale eseguirà uno studio sull'impatto del cambiamento di scope sul progetto,
ponendo particolare attenzione al mantenimento dell'integrità concettuale, e durante l'intero processo potrà rifiutare
la richiesta. In caso il cambiamento possa essere applicato, la richiesta verrà approvata e verranno messe in campo le
